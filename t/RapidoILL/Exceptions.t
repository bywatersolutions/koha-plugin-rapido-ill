...
subtest 'RapidoILL::Exceptions tests' => sub {
    ...
    subtest 'RapidoILL::Exception::BadPickupLocation' => sub {
        ...
        throws_ok {
            RapidoILL::Exception::BadPickupLocation->throw( value => { invalid => 'structure' } )
        }
    ...
    subtest 'RapidoILL::Exception::InvalidPod' => sub {
        ...
        throws_ok {
            RapidoILL::Exception::InvalidPod->throw( pod => 'nonexistent-pod' )
        }
    ...
    subtest 'RapidoILL::Exception::InvalidStringNormalizer' => sub {
        ...
        throws_ok {
            RapidoILL::Exception::InvalidStringNormalizer->throw( normalizer => 'invalid_method' )
        }
    ...
    subtest 'RapidoILL::Exception::MissingConfigEntry' => sub {
        ...
        throws_ok {
            RapidoILL::Exception::MissingConfigEntry->throw( entry => 'base_url' )
        }
    ...
    subtest 'RapidoILL::Exception::MissingParameter' => sub {
        ...
        throws_ok {
            RapidoILL::Exception::MissingParameter->throw( param => 'patron_id' )
        }
    ...
    subtest 'RapidoILL::Exception::UnknownItemId' => sub {
        ...
        throws_ok {
            RapidoILL::Exception::UnknownItemId->throw( item_id => 12345 )
        }
    ...
    subtest 'RapidoILL::Exception::UnknownBiblioId' => sub {
        ...
        throws_ok {
            RapidoILL::Exception::UnknownBiblioId->throw( biblio_id => 67890 )
        }
    ...
    subtest 'RapidoILL::Exception::UnknownPatronId' => sub {
        ...
        throws_ok {
            RapidoILL::Exception::UnknownPatronId->throw( patron_id => 'UNKNOWN123' )
        }
