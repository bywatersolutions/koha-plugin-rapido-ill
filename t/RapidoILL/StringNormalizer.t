...
subtest 'StringNormalizer tests' => sub {
    ...
    subtest 'remove_all_spaces method' => sub {
        ...
        is(
            $normalizer->remove_all_spaces("hello\t\nworld"), 'helloworld',
            'remove_all_spaces removes all whitespace'
        );
        ...
        is(
            $normalizer->remove_all_spaces('   '), '',
            'remove_all_spaces removes all spaces when string is only spaces'
        );
    ...
    subtest 'process method with single normalizer' => sub {
        ...
        is(
            $remove_spaces_normalizer->process('   hello world   '), 'helloworld',
            'process with remove_all_spaces normalizer works'
        );
    };
    ...
    subtest 'process method with multiple normalizers' => sub {
        ...
        is(
            $no_normalizers->process('   hello world   '), '   hello world   ',
            'empty normalizers array leaves string unchanged'
        );
        ...
        is(
            $remove_then_trim->process('   hello world   '), 'helloworld',
            'remove_all_spaces + trim works (order test)'
        );
    };
};
