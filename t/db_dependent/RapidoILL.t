...
subtest 'configuration() tests' => sub {
    ...
    subtest 'Configuration parsing and structure' => sub {
        ...
        is($config->{'dev03-na'}->{base_url}, 'https://dev03-na.alma.exlibrisgroup.com', 
